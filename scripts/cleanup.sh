...
# Unified cleanup script: kills prismd processes and cleans build/data directories
#
...
# TODO: Add flags like --keep-bin/--keep-data for selective cleanup
# TODO: Extend to clean logs, temp volumes, and Firecracker artifacts
